...
namespace Hohoema.UseCase.Playlist
{
    ...
    public class UserMylistManager : FixPrism.BindableBase
    {
		...
		public async Task<ContentManageResult> AddMylist(string name, string description, bool isPublic, MylistGroupDefaultSort default_sort, MylistGroupIconType iconType)
		{
