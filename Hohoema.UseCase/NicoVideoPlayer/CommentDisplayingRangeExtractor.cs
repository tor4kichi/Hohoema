...
namespace Hohoema.UseCase
{
    ...
    {
        public CommentDisplayingRangeExtractor(PlayerSettingsRepository playerSettingsRepository)
        {
        ...
        {
            return startPosition - _playerSettingsRepository.CommentDisplayDuration;
        }
