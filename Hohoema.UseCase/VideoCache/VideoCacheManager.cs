...
namespace Hohoema.UseCase.VideoCache
{
    ...
    {
        public CacheSaveFolder(CacheSettingsRepository cacheSettingsRepository)
        {
        ...
        */
        ...
        public async Task<CacheFolderAccessState> GetVideoCacheFolderState()
        {
            ...
            if (false == _cacheSettingsRepository.IsCacheEnabled)
            {
    ...
    public class VideoCacheManager : AsyncInitialize, IDisposable
    {
        ...
        Models.Helpers.AsyncLock _CacheRequestProcessingLock = new Models.Helpers.AsyncLock();
        ...
        private async Task TryNextCacheRequestedVideoDownload()
        {
            ...
            var downloadSession = await prepareResult.CreateVideoSessionAsync(nextRequest.PriorityQuality == NicoVideoQuality.Unknown ? _cacheSettingsRepository.DefaultCacheQuality : nextRequest.PriorityQuality);
