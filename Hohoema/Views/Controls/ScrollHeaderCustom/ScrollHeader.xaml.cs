        ...
        private void UpdateScrollHeaderBehavior()
        {
            ...
            switch (Mode)
            {
                ...
                case ScrollHeaderMode.QuickReturn:
                    Microsoft.Xaml.Interactivity.Interaction.GetBehaviors(targetListViewBase).Add(new Hohoema.Views.Controls.QuickReturnHeaderBehavior());
                    break;
                case ScrollHeaderMode.Sticky:
                    Microsoft.Xaml.Interactivity.Interaction.GetBehaviors(targetListViewBase).Add(new Hohoema.Views.Controls.StickyHeaderBehavior());
                    break;
