    ...
    public sealed class OpenVideoOwnerSeriesListCommand : CommandBase
    {
        ...
        protected override async void Execute(object parameter)
        {
            try
            {
                ...
                {
                    _pageManager.OpenPageWithId(Models.Domain.PageNavigation.HohoemaPageType.UserSeries, provider.ProviderId);
                    return;
                }
            }
            catch { }
            ...
            if (parameter is IVideoContent content)
            {
                ...
                {
                    _pageManager.OpenPageWithId(Models.Domain.PageNavigation.HohoemaPageType.UserSeries, video.ProviderId);
                }
            }
        }
    }
