...
public abstract partial class HohoemaListingPageViewModelBase<ITEM_VM> : HohoemaPageViewModelBase
{
    ...
    public partial class HohoemaIncrementalLoadingCollection : IncrementalLoadingCollection<IIncrementalSource<ITEM_VM>, ITEM_VM>
    {
    ...
    [ObservableProperty]
    public partial int MaxItemsCount { get; set; }

    [ObservableProperty]
    public partial int LoadedItemsCount { get; set; }
    ...
    [ObservableProperty]
    public partial bool CanChangeSort { get; set; }
