...
public sealed partial class App : Application
{
    ...
    private async Task EnsureInitializeAsync()
    {
        ...
        Resources["DeviceType_IsXbox"] = DeviceTypeHelper.IsXbox;
        Resources["DeviceType_IsMobile"] = DeviceTypeHelper.IsMobile;
        Resources["DeviceType_IsDesktop"] = DeviceTypeHelper.IsDesktop;
        Resources["IsDebug"] = true;
    ...
    private async void OnInitialized()
    {
        ...
        if (update.HasAppUpdate && update.AppUpdate != null)
        {
            ...
            Container.Resolve<IMessenger>().Send(new InAppNotificationMessage(new() 
            {                
