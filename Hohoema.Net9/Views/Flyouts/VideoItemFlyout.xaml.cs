...
public sealed partial class VideoItemFlyout : MenuFlyout
{
    ...
    private WatchHistoryRemoveItemCommand _WatchHistoryRemoveItemCommand => CommunityToolkit.Mvvm.DependencyInjection.Ioc.Default.GetRequiredService<WatchHistoryRemoveItemCommand>();
