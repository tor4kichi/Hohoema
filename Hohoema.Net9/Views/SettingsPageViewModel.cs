...
public sealed partial class SettingsPageViewModel : HohoemaPageViewModelBase
{
        ...
        )
    {
        ...
        IsDebugModeEnabled = (App.Current as App).IsDebugModeEnabled;
    ...
    [ObservableProperty]
    public partial PackageVersion CurrentAppVersion { get; set; }

    [ObservableProperty]
    public partial PackageVersion UpdateAppVersion { get; set; }

    [ObservableProperty]
    [NotifyCanExecuteChangedFor(nameof(AppUpdateCommand))]
    public partial bool HasAppUpdate { get; set; }

    [ObservableProperty]
    public partial bool NowProgressUpdateDownloadAndInstall { get; set; }

    [ObservableProperty]
    public partial float UpdateProgress { get; set; }

    [ObservableProperty]
    public partial bool RequiredRestartForUpdateCompleted { get; set; }
    ...
    // デバッグ設定
    [ObservableProperty]
    public partial bool IsDebugModeEnabled { get; set; }
    ...
    private void InitializeAppearanceSettings()
    {
        ...
        SelectedTheme = AppearanceSettings.ApplicationTheme;
        StartupPageType = AppearanceSettings.FirstAppearPageType;
        IsDefaultFullScreen = ApplicationView.PreferredLaunchWindowingMode == ApplicationViewWindowingMode.FullScreen;
    ...
    [ObservableProperty]
    public partial HohoemaPageType StartupPageType { get; set; }
    ...
    [ObservableProperty]
    public partial bool IsDefaultFullScreen { get; set; }
    ...
    private void InitializeFilters()
    {
        ...
        NgVideoOwnerUserIdEnable = _videoFilteringRepository.NGVideoOwnerUserIdEnable;
        NGVideoOwnerUserIds = _videoFilteringRepository.GetVideoOwnerIdFilteringEntries();

        // NG Keyword on Video Title       
        NGVideoTitleKeywordEnable = _videoFilteringRepository.NGVideoTitleKeywordEnable;
        TestText = _videoFilteringRepository.NGVideoTitleTestText;
        /*
    ...
    [ObservableProperty]
    public partial bool NgVideoOwnerUserIdEnable { get; set; }
    ...
    [ObservableProperty]
    public partial List<VideoOwnerIdFilteringEntry> NGVideoOwnerUserIds { get; set; }
    ...
    [ObservableProperty]
    public partial bool NGVideoTitleKeywordEnable { get; set; }
    ...
    [ObservableProperty]
    public partial string NGVideoTitleKeywordError { get; set; }
    ...
    {
        DefaultCacheQuality = VideoCacheSettings.DefaultCacheQuality;
        IsAllowDownloadOnMeteredNetwork = VideoCacheSettings.IsAllowDownloadOnMeteredNetwork;
        MaxVideoCacheStorageSize = VideoCacheSettings.MaxVideoCacheStorageSize;        
    }
    ...
    [ObservableProperty]
    public partial NicoVideoQuality DefaultCacheQuality { get; set; }
    ...
    [ObservableProperty]
    public partial bool IsAllowDownloadOnMeteredNetwork { get; set; }
    ...
    [ObservableProperty]
    public partial long? MaxVideoCacheStorageSize { get; set; }
