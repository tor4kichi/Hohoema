...
namespace Microsoft.Toolkit.Uwp.UI.Controls.TextToolbarButtons.Common
{
    ...
    public partial class CommonButtons
    {
        ...
        public async void OpenLinkCreator(ToolbarButton button)
        {
            ...
            selection.GetText(TextGetOptions.FormatRtf, out string labeltext);
            labelBox.Document.SetText(TextSetOptions.FormatRtf, labeltext);
            ...
            {
                labelBox.Document.GetText(TextGetOptions.None, out string labelText);
                labelBox.Document.GetText(TextGetOptions.FormatRtf, out string formattedlabelText);
