    ...
    , ITitleUpdatablePage
{
        ...
        : base(loggerFactory.CreateLogger<SearchResultLivePageViewModel>())
    {
        ...
        SelectedSort = new ReactiveProperty<Sort>(Sort.RecentAsc, mode: ReactivePropertyMode.DistinctUntilChanged);
        SelectedStatus = new ReactiveProperty<SearchLiveStatus>(SearchLiveStatus.ON_AIR, mode: ReactivePropertyMode.DistinctUntilChanged);
    ...
    public IReadOnlyList<LiveStatus> LiveStatusItems { get; } = new[] { LiveStatus.Onair, LiveStatus.Past, LiveStatus.BeforeRelease};
    public IReadOnlyList<Sort> SortOptionItems { get; } = Enum.GetValues(typeof(Sort)).Cast<Sort>().ToArray();
    ...
    public ReactiveProperty<SearchLiveStatus> SelectedStatus { get; private set; }
    public ReactiveProperty<Sort> SelectedSort { get; private set; }
...
public class LiveSearchSource : IIncrementalSource<LiveInfoListItemViewModel>
{
    ...
    public SearchLiveStatus Status { get; }
