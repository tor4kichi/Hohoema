...
namespace Hohoema.Models.Repository.Niconico.NicoVideo
{
    ...
    {
        public Database.NicoVideo Deleted { get; set; }
    }
    ...
    public sealed class NicoVideoProvider : ProviderBase
    {
        public NicoVideoProvider(
            Hohoema.Models.Niconico.NiconicoSession niconicoSession
            )
        ...
        public event EventHandler<VideoDeletedEvent> VideoDeletedFromServer;
        ...
        private void PublishVideoDeletedEvent(Database.NicoVideo deletedVideo)
        {
            ...
            {
                VideoDeletedFromServer?.Invoke(this, new VideoDeletedEvent() { Deleted = deletedVideo });
            }
        }
                ...
                try
                {
                    ...
                    if (res.Status == "ok")
                    {
                        ...
                        if (info.IsDeleted && int.TryParse(res.Video.__deleted, out int deleteType))
                        {
                            try
                            {
                                info.PrivateReasonType = (Hohoema.Database.PrivateReasonType)deleteType;
                            }
                            catch { }
                        }
                    }
        ...
        public async Task<WatchApiResponse> GetWatchApiResponse(string rawVideoId, bool forceLowQuality = false)
        {
            ...
            
            {
                try
                {
                    ...
                    info.PrivateReasonType = (Hohoema.Database.PrivateReasonType)res.PrivateReason;
