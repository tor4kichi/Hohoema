...
namespace Hohoema.Models.Niconico.Account
{
    ...
    public static class AccountManager 
    {
        ...
        private static async Task _AddOrUpdateAccount_Xbox(string mailAddress, string password)
        {
            ...
            var encryptedPassword = EncryptHelper.EncryptStringHelper(password, encryptKey);
        ...
        public static async Task<Tuple<string, string>> _GetPrimaryAccount_Xbox()
        {
            ...
            foreach (var pair in container.Values)
            {
                ...
                var plainPassword = EncryptHelper.DecryptStringHelper(encryptedPassword, encryptKey);
