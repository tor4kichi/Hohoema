...
namespace Hohoema.Models.Helpers
{
    public sealed class HttpRandomAccessStream : IRandomAccessStreamWithContentType
    {
        ...
        private async Task SendRequesAsync()
        {
            ...
            {
                throw new Models.Infrastructure.HohoemaException("HTTP server did not reply with a '206 Partial Content' status.");
            }
            ...
            {
                throw new Models.Infrastructure.HohoemaException(String.Format(
