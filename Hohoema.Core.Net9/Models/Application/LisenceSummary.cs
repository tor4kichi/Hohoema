...
[JsonSerializable(typeof(LisenceSummary))]
public sealed partial class LiscenceSummarySourceGenerationContext : JsonSerializerContext
{
...
public sealed class LisenceSummary
{
    ...
    {        
        ...
        using (var readStream = await file.OpenStreamForReadAsync())
        {
            ...
            return await System.Text.Json.JsonSerializer.DeserializeAsync<LisenceSummary>(
                readStream,
                new System.Text.Json.JsonSerializerOptions() {  TypeInfoResolver = LiscenceSummarySourceGenerationContext.Default },
