...
public sealed class SubscriptionFeedUpdatedMessage : ValueChangedMessage<SubscriptionFeedUpdateResult>
{
    public SubscriptionFeedUpdatedMessage(SubscriptionFeedUpdateResult value) : base(value)
    {
