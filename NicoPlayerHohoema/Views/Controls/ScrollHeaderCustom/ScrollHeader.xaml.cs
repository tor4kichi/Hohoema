        ...
        private void UpdateScrollHeaderBehavior()
        {
            ...
            switch (Mode)
            {
                ...
                case ScrollHeaderMode.QuickReturn:
                    Microsoft.Xaml.Interactivity.Interaction.GetBehaviors(targetListViewBase).Add(new NicoPlayerHohoema.Views.Controls.QuickReturnHeaderBehavior());
                    break;
                case ScrollHeaderMode.Sticky:
                    Microsoft.Xaml.Interactivity.Interaction.GetBehaviors(targetListViewBase).Add(new NicoPlayerHohoema.Views.Controls.StickyHeaderBehavior());
                    break;
