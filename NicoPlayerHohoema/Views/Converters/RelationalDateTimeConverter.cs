		...
		private static DurationToTextConvertInfo[] DurationToText = new DurationToTextConvertInfo[]
			{
				...
				new DurationToTextConvertInfo{ Duration = TimeSpan.FromMinutes(5), GetText = (t) => "５分前"},
				new DurationToTextConvertInfo{ Duration = TimeSpan.FromMinutes(15), GetText = (t) => "１５分前"},
				new DurationToTextConvertInfo{ Duration = TimeSpan.FromMinutes(30), GetText = (t) => "３０分前"},
				new DurationToTextConvertInfo{ Duration = TimeSpan.FromMinutes(30), GetText = (t) => "４５分前"},
				new DurationToTextConvertInfo{ Duration = TimeSpan.FromMinutes(30), GetText = (t) => "４５分前"},
				new DurationToTextConvertInfo{ Duration = TimeSpan.FromMinutes(30), GetText = (t) => "４５分前"},
